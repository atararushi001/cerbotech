            ...
            <div className="col-lg-6 col-md-12">
              <div className="about-content">
                <div className="section-title">
                  ...
                  <p>
                  CerboTech is a Technology Organization Researching in the elds of Brain Skills, Cognitive Skills,
Brain Computer Interface (BCI) Technology and Developing Programs for Cognitive Fitness and Mental Wellness.
We apply BCI Technology to analyse and enhance Cognitive Skills such as Focus, Memory, Concentration,
Creativity along with various Mental Wellness parameters.
Our programs help children improve academic performance, behavioural patterns and smoothen their
Sleep Patterns.
                  </p>
                </div>
