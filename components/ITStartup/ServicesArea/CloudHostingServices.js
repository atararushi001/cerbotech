            ...
            <div className="col-lg-6 col-md-12 services-content">
              ...
              <div className="row">
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Database /> Know your child's Concentration Levels in 2 minutes
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Globe />Workshop that Increase KidS Cognitive Functionalities
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.File /> Observe Tangible Results
                  </div>
                </div>
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Monitor /> Brainwave based real time report on Brain Prole 
                  </div>
                </div>
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.TrendingUp />  Online Brain Games Module which Increase Kid's Attentiveness
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Folder /> Scientically Veried Brain Stimulation Music, Brain Entrainment Beats
                    and Brain Traininq Activities
                  </div>
                </div>
