          ...
          <div className="row h-100 justify-content-center align-items-center">
            ...
            <div className="col-lg-6 col-md-12 services-content">
              <div className="section-title">
                ...
                <p>
                Self-Improvement and Mental Wellness
                </p>
              </div>
              ...
              <div className="row">
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Layout />   Self-Improvement and Mental Wellness
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Code />Improved Academic Performance
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Smartphone />Increased Positivity & Self Confidence
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Code /> Ability to manage Performance Stress
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Smartphone />Sharper Memory
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Percent />Smooth Sleep Patterns
                  </div>
                </div>
